...
function run_users_endpoint(array $params): array {
    $path = __DIR__ . '/../public/admin-api/users.php';
...
echo "admin API users admin filter tests passed\n";

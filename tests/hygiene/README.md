...
- `container-runtime-hygiene.test.mjs`: rejects privileged services, unscoped root users, Docker socket and host-PID drift, unsafe or unbounded Compose tmpfs exceptions, and API resolver pinning that would block outbound providers.

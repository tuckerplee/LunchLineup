...
export const APPLICATION_API_OPERATIONS = [
  ...
  { operationId: 'getStaffSchedulingProfile', method: 'GET', path: '/users/:userId/scheduling-profile', tag: 'People', summary: 'Read one staff scheduling profile' },
  { operationId: 'updateStaffSchedulingProfile', method: 'PUT', path: '/users/:userId/scheduling-profile', tag: 'People', summary: 'Replace one staff scheduling profile' },
  { operationId: 'getStaffMember', method: 'GET', path: '/users/:userId', tag: 'People', summary: 'Read one staff member' },
  { operationId: 'createStaffInvitation', method: 'POST', path: '/users/invite', tag: 'People', summary: 'Invite a staff member' },
  { operationId: 'getStaffInvitation', method: 'GET', path: '/users/:userId/invitation', tag: 'People', summary: 'Read invitation delivery state' },
  { operationId: 'retryStaffInvitation', method: 'POST', path: '/users/:userId/invitation/retry', tag: 'People', summary: 'Retry invitation delivery' },
  { operationId: 'reissueStaffInvitation', method: 'POST', path: '/users/:userId/invitation/reissue', tag: 'People', summary: 'Reissue an invitation' },
  { operationId: 'resetStaffPin', method: 'POST', path: '/users/:userId/pin/reset', tag: 'People', summary: 'Reset a staff PIN' },
  { operationId: 'replaceCurrentPin', method: 'PUT', path: '/users/me/pin', tag: 'People', summary: 'Replace the current user PIN' },
  { operationId: 'deleteStaffMember', method: 'DELETE', path: '/users/:userId', tag: 'People', summary: 'Deactivate a staff member' },
  { operationId: 'getStaffAccess', method: 'GET', path: '/users/:userId/access', tag: 'People', summary: 'Read one staff access assignment' },
  { operationId: 'updateStaffAccess', method: 'PUT', path: '/users/:userId/access', tag: 'People', summary: 'Replace one staff access assignment' },
  { operationId: 'createAccessRole', method: 'POST', path: '/users/roles', tag: 'People', summary: 'Create an access role' },
  { operationId: 'updateAccessRole', method: 'PUT', path: '/users/roles/:roleId', tag: 'People', summary: 'Replace an access role' },
  { operationId: 'deleteAccessRole', method: 'DELETE', path: '/users/roles/:roleId', tag: 'People', summary: 'Delete an access role' },

  { operationId: 'listScheduleSummaries', method: 'GET', path: '/schedules', tag: 'Operations', summary: 'List schedule summaries' },
  { operationId: 'listShiftSummaries', method: 'GET', path: '/shifts', tag: 'Operations', summary: 'List shift summaries' },
  { operationId: 'listStaffRoster', method: 'GET', path: '/shifts/staff-roster', tag: 'Operations', summary: 'List the bounded scheduling roster' },
  { operationId: 'listLunchBreakRows', method: 'GET', path: '/lunch-breaks', tag: 'Operations', summary: 'List lunch and break rows' },
  { operationId: 'getLunchBreakPolicy', method: 'GET', path: '/lunch-breaks/policy', tag: 'Operations', summary: 'Read the lunch and break policy' },
  { operationId: 'updateLunchBreakPolicy', method: 'PUT', path: '/lunch-breaks/policy', tag: 'Operations', summary: 'Replace the lunch and break policy' },
  { operationId: 'generateLunchBreakPlan', method: 'POST', path: '/lunch-breaks/generate', tag: 'Operations', summary: 'Generate one lunch and break plan' },
  { operationId: 'importLunchBreakShifts', method: 'POST', path: '/lunch-breaks/setup-shifts', tag: 'Operations', summary: 'Import manual shifts into a break plan' },
  { operationId: 'updateShiftBreakPlan', method: 'PUT', path: '/lunch-breaks/shift/:shiftId', tag: 'Operations', summary: 'Replace one shift break plan' },

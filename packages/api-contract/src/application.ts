...
export const APPLICATION_API_OPERATIONS = [
  ...
  { operationId: 'getPayrollExportEntitlement', method: 'GET', path: '/payroll/export-entitlement', tag: 'Payroll', summary: 'Read payroll export entitlement', native: true },
  { operationId: 'listPayrollPolicies', method: 'GET', path: '/payroll/policies', tag: 'Payroll', summary: 'List payroll policy versions', native: true },
  { operationId: 'getPayrollPolicy', method: 'GET', path: '/payroll/policy', tag: 'Payroll', summary: 'Read the current payroll policy', native: true },
  { operationId: 'createPayrollPolicy', method: 'PUT', path: '/payroll/policy', tag: 'Payroll', summary: 'Create a payroll policy version', native: true },
  { operationId: 'listPayrollPeriods', method: 'GET', path: '/payroll/periods', tag: 'Payroll', summary: 'List payroll periods', native: true },
  { operationId: 'createPayrollPeriod', method: 'POST', path: '/payroll/periods', tag: 'Payroll', summary: 'Create a payroll period', native: true },
  { operationId: 'getPayrollPeriod', method: 'GET', path: '/payroll/periods/:periodId', tag: 'Payroll', summary: 'Read one payroll period', native: true },
  { operationId: 'adoptPayrollTimeCards', method: 'POST', path: '/payroll/periods/:periodId/adopt', tag: 'Payroll', summary: 'Adopt time cards into a payroll period', native: true },
  { operationId: 'startPayrollReview', method: 'POST', path: '/payroll/periods/:periodId/review', tag: 'Payroll', summary: 'Start payroll review', native: true },
  { operationId: 'decidePayrollEntries', method: 'POST', path: '/payroll/periods/:periodId/decisions', tag: 'Payroll', summary: 'Record payroll entry decisions', native: true },
  { operationId: 'lockPayrollPeriod', method: 'POST', path: '/payroll/periods/:periodId/lock', tag: 'Payroll', summary: 'Lock a payroll period', native: true },
  { operationId: 'createPayrollAmendment', method: 'POST', path: '/payroll/entries/:entryId/amendments', tag: 'Payroll', summary: 'Create a payroll amendment', native: true },
  { operationId: 'decidePayrollAmendment', method: 'POST', path: '/payroll/amendments/:amendmentId/decision', tag: 'Payroll', summary: 'Decide a payroll amendment', native: true },
  { operationId: 'createPayrollExport', method: 'POST', path: '/payroll/periods/:periodId/exports', tag: 'Payroll', summary: 'Create a payroll export', native: true },
  { operationId: 'getPayrollExport', method: 'GET', path: '/payroll/exports/:exportId', tag: 'Payroll', summary: 'Read one payroll export', native: true },
  { operationId: 'downloadPayrollExport', method: 'GET', path: '/payroll/exports/:exportId/download', tag: 'Payroll', summary: 'Download one payroll export', responseKind: 'download', bodyLimitBytes: 25 * MiB, native: true },
  { operationId: 'reconcilePayrollExport', method: 'POST', path: '/payroll/exports/:exportId/reconciliation', tag: 'Payroll', summary: 'Reconcile a payroll export', native: true },

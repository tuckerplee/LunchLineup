...
const OMITTED_FIELDS = [
  ...
  "scheduleChangeSet.idempotencyKeyHash",
  "scheduleChangeSet.requestHash",
  "scheduleChangeSet.request",
  "scheduleChangeSet.response",
...
export const TENANT_EXPORT_COLLECTIONS: readonly ExportCollection[] = [
  ...
  },
  {
    ...
    name: "scheduleChangeSets",
    delegate: "scheduleChangeSet",
    where: (tenantId) => ({ tenantId }),
    select: {
      id: true,
      scheduleId: true,

...
- `scheduler-responsive-accessibility.test.ts`: fixed-scale mobile timeline, desktop-fit preservation, separate modifier-copy/move callbacks, touch-friendly duplication wiring, horizontal keyboard inspection, date naming, staff-row semantics, and compact-label contrast coverage.

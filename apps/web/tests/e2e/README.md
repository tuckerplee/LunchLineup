...
- `staff-admin-safety.spec.ts`: manager scheduling-profile workflow with public location IDs, authoritative PDF-import cost preflight and settlement, fail-closed read recovery, skills and overnight availability, Staff-default invitation, destructive-action confirmation, public-ID-bound MFA recovery, capability separation, and responsive platform-admin coverage.

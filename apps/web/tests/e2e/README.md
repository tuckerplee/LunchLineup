...
- `month-volume-workflows.spec.ts`: opt-in full-stack API-v2 multi-user schedule, keyed change-set/lunch generation volume, credit settlement, replay, and persisted readback contract test.

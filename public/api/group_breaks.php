...
$employees = isset($payload['employees']) && is_array($payload['employees']) ? $payload['employees'] : [];
...
foreach ($employees as &$e) {
    $e['start'] = isset($e['start']) ? (float) $e['start'] : 0.0;
    if (isset($e['lunchDuration'])) {
        $e['lunchDuration'] = ((float) $e['lunchDuration']) / 60;
    }
}
unset($e);

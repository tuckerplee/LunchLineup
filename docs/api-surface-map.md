...
- `PUT /api/v1/admin/users/{publicUserId}`
- `POST /api/v1/admin/users/{publicUserId}/mfa/reset`
- `POST /api/v1/admin/users/{publicUserId}/lock`
- `POST /api/v1/admin/users/{publicUserId}/unlock`
- `POST /api/v1/admin/users/{publicUserId}/suspend`
- `POST /api/v1/admin/users/{publicUserId}/activate`
